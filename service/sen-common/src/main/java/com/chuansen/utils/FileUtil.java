...
public class FileUtil extends cn.hutool.core.io.FileUtil {
     ...
     * @throws Exception
     */
    public static void downloadExcel(List<Map<String, Object>> list, String titleName, HttpServletResponse response) throws IOException {
        //String tempPath =System.getProperty("java.io.tmpdir") + IdUtil.fastSimpleUUID() + ".xlsx";
        String tempPath = titleName + ".xlsx";
